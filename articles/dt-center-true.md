...
![](fig-vignettes-dt-center-true-no-error-ssm-1.png)![](fig-vignettes-dt-center-true-no-error-ssm-2.png)![](fig-vignettes-dt-center-true-no-error-ssm-3.png)
...
![](fig-vignettes-dt-center-true-error-ssm-1.png)![](fig-vignettes-dt-center-true-error-ssm-2.png)![](fig-vignettes-dt-center-true-error-ssm-3.png)
...
`fit`` ``<-`` `[`FitVARMxID`](https://github.com/jeksterslab/fitVARMxID/reference/FitVARMxID.md)`(`` `` data ``=`` ``data``,`` `` observed ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"y1"``, ``"y2"``, ``"y3"``)``,`` `` id ``=`` ``"id"``,`` `` center ``=`` ``TRUE``,`` `` ncores ``=`` ``parallel``::`[`detectCores`](https://rdrr.io/r/parallel/detectCores.html)`(``)`` ``)`

#### Parameter estimates

[`summary`](https://rdrr.io/r/base/summary.html)`(`` `` ``fit``,`` `` means ``=`` ``TRUE``,`` `` ncores ``=`` ``parallel``::`[`detectCores`](https://rdrr.io/r/parallel/detectCores.html)`(``)`` ``)`` ``#> Call:`` ``#> FitVARMxID(data = data, observed = c("y1", "y2", "y3"), id = "id", `` ``#> center = TRUE, ncores = parallel::detectCores())`` ``#> `` ``#> Convergence:`` ``#> 100.0%`` ``#> `` ``#> Means of the estimated paramaters per individual.`` ``#> mu[1,1] mu[2,1] mu[3,1] beta[1,1] beta[2,1] beta[3,1] beta[1,2] beta[2,2] `` ``#> 3.0548 6.1622 4.8943 0.7001 0.4990 -0.0991 -0.0022 0.5998 `` ``#> beta[3,2] beta[1,3] beta[2,3] beta[3,3] psi[1,1] psi[2,1] psi[3,1] psi[2,2] `` ``#> 0.4038 -0.0051 -0.0022 0.4982 0.0997 0.0004 -0.0003 0.0990 `` ``#> psi[3,2] psi[3,3] `` ``#> 0.0005 0.0994`
