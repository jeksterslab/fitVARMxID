...
`sim`` ``<-`` `[`SimSSMLinSDEFixed`](https://github.com/jeksterslab/simStateSpace/reference/SimSSMLinSDEFixed.html)`(`\
`  n ``=`` ``n``,`\
`  time ``=`` ``time``,`\
`  delta_t ``=`` ``0.1``,`\
`  mu0 ``=`` ``mu0``,`\
...
\
`fit`` ``<-`` `[`FitVARMxID`](https://github.com/jeksterslab/fitVARMxID/reference/FitVARMxID.md)`(`\
`  data ``=`` ``data``,`\
...
`#>     1.1612     1.1240     0.3841    -0.4132     0.7900    -0.4525    -0.0063 `\
`#>  beta[2,2]  beta[3,2]  beta[1,3]  beta[2,3]  beta[3,3]   psi[1,1]   psi[2,1] `\
`#>    -0.5353     0.7518    -0.0141    -0.0187    -0.7396     0.1007     0.0003 `\
`#>   psi[3,1]   psi[2,2]   psi[3,2]   psi[3,3] `\
`#>    -0.0002     0.0993     0.0003     0.1004`
