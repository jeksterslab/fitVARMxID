...
#> [1] fitVARMxID_1.0.3     OpenMx_2.22.11       simStateSpace_1.2.16
#> 
#> loaded via a namespace (and not attached):
#>  [1] digest_0.6.39         xfun_0.57             Matrix_1.7-4         
#>  [4] lattice_0.22-9        glue_1.8.0            knitr_1.51           
#>  [7] parallel_4.5.3        RcppParallel_5.1.11-2 lifecycle_1.0.5      
#> [10] cli_3.6.5.9000        rProject_0.0.25       vctrs_0.7.2          
#> [13] grid_4.5.3            compiler_4.5.3        tools_4.5.3          
...
## Memory
    ...
    #> Mem:            44Gi       3.6Gi        38Gi        14Mi       3.3Gi        40Gi
    #> Swap:           22Gi          0B        22Gi
