...
#>           mu[1,1] mu[2,1] beta[1,1] beta[2,1] beta[1,2] beta[2,2] psi[1,1]
#> DTVAR_ID1  0.0058  0.0071    0.3316   -0.0198    0.0270    0.5393    1e-03
#> DTVAR_ID2 -0.0028 -0.0199    0.5467   -0.0201   -0.0488    0.2975    8e-04
#> DTVAR_ID3 -0.0043 -0.0017    0.5281   -0.3325    0.0109    0.3614    9e-04
#> DTVAR_ID4 -0.0131  0.0033    0.1608   -0.1218   -0.0299    0.4818    7e-04
#> DTVAR_ID5 -0.0011  0.0033    0.2991    0.0349   -0.0802    0.4659    1e-03
#>           psi[2,1] psi[2,2]
#> DTVAR_ID1    1e-04   0.0009
#> DTVAR_ID2    1e-04   0.0011
#> DTVAR_ID3   -2e-04   0.0012
#> DTVAR_ID4    0e+00   0.0010
#> DTVAR_ID5   -2e-04   0.0009
summary(fit)
#> Call:
#> FitVARMxID(data = data, observed = paste0("y", seq_len(p)), id = "id", 
#>     center = TRUE)
...
#> 
converged(fit)
#> DTVAR_ID1 DTVAR_ID2 DTVAR_ID3 DTVAR_ID4 DTVAR_ID5 
...
#> 
#> Estimated paramaters per individual.
#>           alpha[1,1] alpha[2,1] beta[1,1] beta[2,1] beta[1,2] beta[2,2]
#> DTVAR_ID1     0.0037     0.0034    0.3316   -0.0198    0.0270    0.5393
#> DTVAR_ID2    -0.0023    -0.0140    0.5467   -0.0201   -0.0488    0.2975
#> DTVAR_ID3    -0.0020    -0.0025    0.5281   -0.3325    0.0109    0.3614
#> DTVAR_ID4    -0.0109     0.0001    0.1608   -0.1218   -0.0299    0.4818
#> DTVAR_ID5    -0.0005     0.0018    0.2991    0.0349   -0.0802    0.4659
#>           psi[1,1] psi[2,1] psi[2,2]
#> DTVAR_ID1    1e-03    1e-04   0.0009
#> DTVAR_ID2    8e-04    1e-04   0.0011
#> DTVAR_ID3    9e-04   -2e-04   0.0012
#> DTVAR_ID4    7e-04    0e+00   0.0010
#> DTVAR_ID5    1e-03   -2e-04   0.0009
summary(fit)
#> Call:
#> FitVARMxID(data = data, observed = paste0("y", seq_len(p)), id = "id", 
#>     center = FALSE)
